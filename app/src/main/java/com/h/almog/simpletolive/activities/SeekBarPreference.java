...
/**
 * Created by Almog on 11/04/2016.
 * A custom seek bar for preference fragment
 */
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    public static int maximum    = 7000;
    public static int interval   = 200;

    private float oldValue = 2000;
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        this.oldValue = sp.getInt(getContext().getResources().getString(R.string.seekBarKey), -1);
        if (oldValue == -1){
            oldValue = 2000;
        }
    ...
    protected Object onGetDefaultValue(TypedArray ta,int index){
        ...
        int dValue = (int)ta.getInt(index, 200);
